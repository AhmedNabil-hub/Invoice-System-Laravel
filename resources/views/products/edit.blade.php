...
@section('page-header')
  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
      <div class="d-flex">
        <h4 class="content-title mb-0 my-auto">Products</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Edit
          Product</span>
      </div>
    </div>
  </div>
              ...
              <div class="row row-sm">
                <div class="col-lg-8">
                  <textarea class="form-control" placeholder="Description" rows="3" @error('description') is-invalid
                    @enderror name="description" value="{{ old('description') ?? '' }}">{{ old('description') ?? $section->description }}</textarea>
                </div>
              </div>
