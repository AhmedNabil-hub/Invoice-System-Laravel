...
@section('page-header')
  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
      <div class="d-flex">
        <h4 class="content-title mb-0 my-auto">Users</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ All
          Users</span>
      </div>
    </div>
  </div>
            ...
            <table class="table text-md-nowrap key-buttons" id="example">
              ...
              <tbody>
                @foreach ($users as $user)
                  <tr>
                    <td class="wd-15p border-bottom-0">{{ $user->id }}</td>
                    <td class="wd-15p border-bottom-0">{{ $user->name }}</td>
                    <td class="wd-25p border-bottom-0">{{ $user->email }}</td>
                    ...
                    <td class="wd-25p border-bottom-0">
                      <div class="btn-icon-list">
                        <a class="btn btn-success btn-icon ml-2" href="{{ route('users.edit', $user->id) }}">
