      ...
      <div class="card">
        <div class="card-header pb-0">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex justify-content-between align-items-center">
							<a class="btn btn-success btn-icon ml-2" href="{{ route('invoices.export') }}">
                <i class="fas fa-file-export"></i>
              </a>
							<a class="btn btn-danger btn-icon ml-2" href="{{ route('invoices.trash') }}">
								<i class="typcn typcn-trash"></i>
							</a>
              <a class="btn btn-primary btn-icon" href="{{ route('invoices.create') }}">
                  ...
                  <tr>
                    ...
                    <td class="wd-25p border-bottom-0">
                      <div class="btn-icon-list">
                        <a class="btn btn-success btn-icon ml-2" href="{{ route('invoices.edit', $invoice->id) }}">
                          <i class="typcn typcn-edit"></i>
                        </a>
                        <a class="btn btn-info btn-icon ml-2" href="{{ route('invoices.show-details', $invoice->id) }}">
